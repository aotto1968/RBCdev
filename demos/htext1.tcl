...
proc Rbc_FindPattern { htext } {
    ...
    button .search.search -text "Search" -command "Rbc_Search&Move $htext"
    bind .search.entry <Return> "Rbc_Search&Move $htext"
    table .search \
