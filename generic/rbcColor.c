    ...
    Tk_Window tkwin;
{
    ...
    //nFreeColors = QueryColormap(colorTabPtr->display, colorMap, usedColors, &nUsedColors);
    memset((char *)inUse, 0, sizeof(int) * NCOLORS);
	...
	//nFreeColors = QueryColormap(colorTabPtr->display, Rbc_DefaultColormap(tkwin), usedColors, &nUsedColors);
