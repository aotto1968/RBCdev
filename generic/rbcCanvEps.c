 ...
 *----------------------------------------------------------------------
 */
inline static int Ot_CanvasTagsParseProc(
  ClientData clientData, Tcl_Interp *interp, Tk_Window tkwin,
    char *value, char *widgRec, int offset) {
  return Tk_CanvasTagsParseProc(clientData,interp,tkwin,(const char*) value, widgRec,offset);
}
void
    ...
    Tcl_Interp *interp; /* Not used. */
{
    ...
    tagsOption.parseProc = Ot_CanvasTagsParseProc;
