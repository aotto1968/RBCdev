...
#ifndef RBC_TREEVIEW_H
#define RBC_TREEVIEW_H
...
#define DEPTH(h, n)	\
		(((h)->flatView) ? 0 : Rbc_TreeNodeDepth((h)->tree, (n)))
...
struct TreeViewColumnStruct {
    ...
    Rbc_TreeKey key;		/* Data cell identifier for current tree. */
    ...
    Rbc_Pad pad;		/* Horizontal padding on either side
				 * of the column. */
...
struct TreeViewStyleStruct {
    ...
    Tcl_HashEntry *hashPtr;	/* If non-NULL, points to the hash
...
struct TreeViewStyleClassStruct {
    ...
    Rbc_ConfigSpec *specsPtr;	/* Style configuration specifications */
...
struct TreeViewEntryStruct {
    Rbc_TreeNode node;		/* Node containing entry */
...
struct TreeViewStruct {
    ...
    Tcl_HashTable entryTable;	/* Table of entry information, keyed by
				 * the node pointer. */

    Tcl_HashTable columnTable;	/* Table of column information. */
    Rbc_Chain *colChainPtr;	/* Chain of columns. Same as the hash
    ...
    Tcl_HashTable selectTable;	/* Hash table of currently selected
				 * entries. */

    Rbc_Chain *selChainPtr;	/* Chain of currently selected
    ...
    int scrollMode;		/* Selects mode of scrolling: either
				 ...
				 * RBC_SCROLL_MODE_LISTBOX, 
				 * or RBC_SCROLL_MODE_CANVAS. */
    /*
    ...
    Tcl_HashTable iconTable;	/* Table of Tk images */

    Tcl_HashTable uidTable;	/* Table of strings. */

    Tcl_HashTable styleTable;	/* Table of cell styles. */
    ...
    Tcl_HashTable entryTagTable;
    Tcl_HashTable buttonTagTable;
    Tcl_HashTable columnTagTable;
    Tcl_HashTable styleTagTable;
...
extern UID Rbc_TreeViewGetUid _ANSI_ARGS_((TreeView *tvPtr, 
	CONST char *string));
extern void Rbc_TreeViewFreeUid _ANSI_ARGS_((TreeView *tvPtr, UID uid));

extern void Rbc_TreeViewEventuallyRedraw _ANSI_ARGS_((TreeView *tvPtr));
extern Tcl_ObjCmdProc Rbc_TreeViewWidgetInstCmd;
extern TreeViewEntry *Rbc_TreeViewNearestEntry _ANSI_ARGS_((TreeView *tvPtr,
	int x, int y, int flags));
extern char *Rbc_TreeViewGetFullName _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr, int checkEntryLabel, Tcl_DString *dsPtr));
extern void Rbc_TreeViewSelectCmdProc _ANSI_ARGS_((ClientData clientData));
extern void Rbc_TreeViewInsertText _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr, char *string, int extra, int insertPos));
extern void Rbc_TreeViewComputeLayout _ANSI_ARGS_((TreeView *tvPtr));
extern void Rbc_TreeViewPercentSubst _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr, char *command, Tcl_DString *resultPtr));
extern void Rbc_TreeViewDrawButton _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr, Drawable drawable, int x, int y));
extern void Rbc_TreeViewDrawValue _ANSI_ARGS_((TreeView *tvPtr,
    TreeViewEntry *entryPtr, TreeViewValue *valuePtr, Drawable drawable,
    int x, int y));
extern void Rbc_TreeViewDrawOuterBorders _ANSI_ARGS_((TreeView *tvPtr, 
	Drawable drawable));
extern int Rbc_TreeViewDrawIcon _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr, Drawable drawable, int x, int y));
extern void Rbc_TreeViewDrawHeadings _ANSI_ARGS_((TreeView *tvPtr, 
	Drawable drawable));
extern void Rbc_TreeViewDrawRule _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewColumn *columnPtr, Drawable drawable));

extern void Rbc_TreeViewConfigureButtons _ANSI_ARGS_((TreeView *tvPtr));
extern int Rbc_TreeViewUpdateWidget _ANSI_ARGS_((Tcl_Interp *interp, 
	TreeView *tvPtr));
extern int Rbc_TreeViewScreenToIndex _ANSI_ARGS_((TreeView *tvPtr, 
	int x, int y));

extern void Rbc_TreeViewFreeIcon _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewIcon icon));
extern TreeViewIcon Rbc_TreeViewGetIcon _ANSI_ARGS_((TreeView *tvPtr,
	CONST char *iconName));
extern void Rbc_TreeViewAddValue _ANSI_ARGS_((TreeViewEntry *entryPtr, 
	TreeViewColumn *columnPtr));
extern int Rbc_TreeViewCreateColumn _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewColumn *columnPtr, char *name, char *defaultLabel));
extern void Rbc_TreeViewDestroyValue _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewValue *valuePtr));
extern TreeViewValue *Rbc_TreeViewFindValue _ANSI_ARGS_((
	TreeViewEntry *entryPtr, TreeViewColumn *columnPtr));
extern void Rbc_TreeViewDestroyColumns _ANSI_ARGS_((TreeView *tvPtr));
extern void Rbc_TreeViewAllocateColumnUids _ANSI_ARGS_((TreeView *tvPtr));
extern void Rbc_TreeViewFreeColumnUids _ANSI_ARGS_((TreeView *tvPtr));
extern void Rbc_TreeViewUpdateColumnGCs _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewColumn *columnPtr));
extern TreeViewColumn *Rbc_TreeViewNearestColumn _ANSI_ARGS_((TreeView *tvPtr,
	int x, int y, ClientData *contextPtr));

extern void Rbc_TreeViewDrawRule _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewColumn *columnPtr, Drawable drawable));
extern int Rbc_TreeViewTextOp _ANSI_ARGS_((TreeView *tvPtr, Tcl_Interp *interp,
	int objc, Tcl_Obj *CONST *objv));
extern int Rbc_TreeViewCombobox _ANSI_ARGS_((TreeView *tvPtr,
	TreeViewEntry *entryPtr, TreeViewColumn *columnPtr));
extern int Rbc_TreeViewCreateEntry _ANSI_ARGS_((TreeView *tvPtr, 
	Rbc_TreeNode node, int objc, Tcl_Obj *CONST *objv, int flags));
extern int Rbc_TreeViewConfigureEntry _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr, int objc, Tcl_Obj *CONST *objv, int flags));
extern int Rbc_TreeViewOpenEntry _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));
extern int Rbc_TreeViewCloseEntry _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));
extern TreeViewEntry *Rbc_TreeViewNextEntry _ANSI_ARGS_((
	TreeViewEntry *entryPtr, unsigned int mask));
extern TreeViewEntry *Rbc_TreeViewPrevEntry _ANSI_ARGS_((
	TreeViewEntry *entryPtr, unsigned int mask));
extern int Rbc_TreeViewGetEntry _ANSI_ARGS_((TreeView *tvPtr, Tcl_Obj *objPtr, 
	TreeViewEntry **entryPtrPtr));
extern int Rbc_TreeViewEntryIsHidden _ANSI_ARGS_((TreeViewEntry *entryPtr));
extern TreeViewEntry *Rbc_TreeViewNextSibling _ANSI_ARGS_((
	TreeViewEntry *entryPtr, unsigned int mask));
extern TreeViewEntry *Rbc_TreeViewPrevSibling _ANSI_ARGS_((
	TreeViewEntry *entryPtr, unsigned int mask));
extern TreeViewEntry *Rbc_TreeViewFirstChild _ANSI_ARGS_((
	TreeViewEntry *parentPtr, unsigned int mask));
extern TreeViewEntry *Rbc_TreeViewLastChild _ANSI_ARGS_((
	TreeViewEntry *entryPtr, unsigned int mask));
extern TreeViewEntry *Rbc_TreeViewParentEntry _ANSI_ARGS_((
	TreeViewEntry *entryPtr));

typedef int (TreeViewApplyProc) _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));

extern int Rbc_TreeViewApply _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr, TreeViewApplyProc *proc, unsigned int mask));

extern int Rbc_TreeViewColumnOp _ANSI_ARGS_((TreeView *tvPtr, 
	Tcl_Interp *interp, int objc, Tcl_Obj *CONST *objv));
extern int Rbc_TreeViewSortOp _ANSI_ARGS_((TreeView *tvPtr, Tcl_Interp *interp,
	int objc, Tcl_Obj *CONST *objv));
extern int Rbc_TreeViewGetColumn _ANSI_ARGS_((Tcl_Interp *interp, 
	TreeView *tvPtr, Tcl_Obj *objPtr, TreeViewColumn **columnPtrPtr));

extern void Rbc_TreeViewSortFlatView _ANSI_ARGS_((TreeView *tvPtr));
extern void Rbc_TreeViewSortTreeView _ANSI_ARGS_((TreeView *tvPtr));

extern int Rbc_TreeViewEntryIsSelected _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));
extern void Rbc_TreeViewSelectEntry _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));
extern void Rbc_TreeViewDeselectEntry _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));
extern void Rbc_TreeViewPruneSelection _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));
extern void Rbc_TreeViewClearSelection _ANSI_ARGS_((TreeView *tvPtr));
extern void Rbc_TreeViewClearTags _ANSI_ARGS_((TreeView *tvPtr,
	TreeViewEntry *entryPtr));
extern int Rbc_TreeViewFindTaggedEntries _ANSI_ARGS_((TreeView *tvPtr, 
	Tcl_Obj *objPtr, TreeViewTagInfo *infoPtr));
extern TreeViewEntry *Rbc_TreeViewFirstTaggedEntry _ANSI_ARGS_((
	TreeViewTagInfo *infoPtr)); 
extern TreeViewEntry *Rbc_TreeViewNextTaggedEntry _ANSI_ARGS_((
	TreeViewTagInfo *infoPtr)); 
extern ClientData Rbc_TreeViewButtonTag _ANSI_ARGS_((TreeView *tvPtr, 
    CONST char *string));
extern ClientData Rbc_TreeViewEntryTag _ANSI_ARGS_((TreeView *tvPtr, 
    CONST char *string));
extern ClientData Rbc_TreeViewColumnTag _ANSI_ARGS_((TreeView *tvPtr, 
    CONST char *string));
extern void Rbc_TreeViewGetTags _ANSI_ARGS_((Tcl_Interp *interp, 
	TreeView *tvPtr, TreeViewEntry *entryPtr, Rbc_List list));
extern void Rbc_TreeViewTraceColumn _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewColumn *columnPtr));
extern TreeViewIcon Rbc_TreeViewGetEntryIcon _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewEntry *entryPtr));
extern void Rbc_TreeViewSetStyleIcon _ANSI_ARGS_((TreeView *tvPtr,
	TreeViewStyle *stylePtr, TreeViewIcon icon));
extern int Rbc_TreeViewGetStyle _ANSI_ARGS_((Tcl_Interp *interp, 
	TreeView *tvPtr, char *styleName, TreeViewStyle **stylePtrPtr));
extern void Rbc_TreeViewFreeStyle _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewStyle *stylePtr));
extern TreeViewStyle *Rbc_TreeViewCreateStyle _ANSI_ARGS_((Tcl_Interp *interp,
	TreeView *tvPtr, int type, char *styleName));
extern void Rbc_TreeViewUpdateStyleGCs _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewStyle *stylePtr));
extern Tk_3DBorder Rbc_TreeViewGetStyleBorder _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewStyle *stylePtr));
extern GC Rbc_TreeViewGetStyleGC _ANSI_ARGS_((TreeViewStyle *stylePtr));
extern Tk_Font Rbc_TreeViewGetStyleFont _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewStyle *stylePtr));
extern XColor *Rbc_TreeViewGetStyleFg _ANSI_ARGS_((TreeView *tvPtr, 
	TreeViewStyle *stylePtr));
extern TreeViewEntry *Rbc_NodeToEntry _ANSI_ARGS_((TreeView *tvPtr, 
	Rbc_TreeNode node));
extern int Rbc_TreeViewStyleOp _ANSI_ARGS_((TreeView *tvPtr, Tcl_Interp *interp,
	int objc, Tcl_Obj *CONST *objv));
...
#define GETLABEL(e)		\
	(((e)->labelUid != NULL) ? (e)->labelUid : Rbc_TreeNodeLabel((e)->node))

#define Rbc_TreeViewGetData(entryPtr, key, objPtrPtr) \
	Rbc_TreeGetValueByKey((Tcl_Interp *)NULL, (entryPtr)->tvPtr->tree, \
	      (entryPtr)->node, key, objPtrPtr)

#endif /* RBC_TREEVIEW_H */
