...
namespace eval ::rbc::Tabnotebook {
  ...
  bind Tabnotebook <ButtonPress-2> [namespace code {
  ...
  bind Tabnotebook <ButtonRelease-2> [namespace code {
  ...
  #
  # ----------------------------------------------------------------------
  bind Tabnotebook <KeyPress-Up>      [namespace code { SelectTab %W "up" }]
  bind Tabnotebook <KeyPress-Down>    [namespace code { SelectTab %W "down" }]
  bind Tabnotebook <KeyPress-Right>   [namespace code { SelectTab %W "right" }]
  bind Tabnotebook <KeyPress-Left>    [namespace code { SelectTab %W "left" }]
  bind Tabnotebook <KeyPress-space>   { %W invoke focus }
  bind Tabnotebook <KeyPress-Return>  { %W invoke focus }

  bind Tabnotebook <KeyPress> [namespace code {
  ...
  #
  # ----------------------------------------------------------------------
  proc ToggleTearoff { widget x y index } {
  ...
  # ----------------------------------------------------------------------
    ...
    proc ObjInit { widget } {
        ...
        $widget bind all <Control-ButtonPress-1> [namespace code { 
            ToggleTearoff %W %X %Y active
        }]
        $widget configure -perforationcommand [namespace code {
            ToggleTearoff %W $x $y select
        }]
