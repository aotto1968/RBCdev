...
namespace eval ::rbc::Hierbox {
  ...
  bind Hierbox <ButtonPress-2> [namespace code {
  ...
  bind Hierbox <ButtonRelease-2> [namespace code {
      %W configure -cursor $cursor
  }]

  bind Hierbox <B1-Leave> [namespace code {
      if { $scroll } {
          AutoScroll %W 
      }
  }]

  bind Hierbox <B1-Enter> [namespace code {
  ...
  bind Hierbox <KeyPress-Up> [namespace code {
      MoveFocus %W up
      if { $space } {
  ...
  bind Hierbox <KeyPress-Down> [namespace code {
      MoveFocus %W down
      if { $space } {
          %W selection toggle focus
      }
  ...
  bind Hierbox <Shift-KeyPress-Up> [namespace code {
      MoveFocus %W prevsibling
  }]

  bind Hierbox <Shift-KeyPress-Down> [namespace code {
      MoveFocus %W nextsibling
  }]

  bind Hierbox <KeyPress-Prior> [namespace code {
      MovePage %W top
  }]

  bind Hierbox <KeyPress-Next> [namespace code {
      MovePage %W bottom
  }]
  ...
  bind Hierbox <KeyPress-space> [namespace code {
      HierboxToggle %W focus
      set space on
  }]

  bind Hierbox <KeyRelease-space> [namespace code { 
      set space off
  }]

  bind Hierbox <KeyPress-Return> [namespace code {
      HierboxToggle %W focus
      set space on
  }]

  bind Hierbox <KeyRelease-Return> [namespace code { 
      set space off
  }]

  bind Hierbox <KeyPress> [namespace code {
      NextMatchingEntry %W %A
  }]

  bind Hierbox <KeyPress-Home> [namespace code {
      MoveFocus %W root
  }]

  bind Hierbox <KeyPress-End> [namespace code {
      MoveFocus %W end
  }]
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::HierboxToggle <hierbox> <index>
  ...
  # ----------------------------------------------------------------------
  proc HierboxToggle { widget index } {
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::Hierbox::MovePage <hierbox> <where>
  # Arguments:	hierbox		hierarchy widget
  #
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::Hierbox::AutoScroll <hierbox>
  #
  ...
  proc AutoScroll { widget } {
      ...
      variable afterId [after 10 ::rbc::Hierbox::AutoScroll $widget]
  }
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::Hierbox::NextMatchingEntry <hierbox> <char>
  # Arguments:	hierbox		hierarchy widget
  #
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::Hierbox::MoveFocus <hierbox> <where>
  #
