...
namespace eval ::rbc::Hiertable {
  ...
  bind Hiertable <ButtonPress-2> [namespace code {
  ...
  bind Hiertable <ButtonRelease-2> [namespace code {
      %W configure -cursor $cursor
  }]

  bind Hiertable <B1-Leave> [namespace code {
      if { $scroll } {
          AutoScroll %W 
      }
  }]

  bind Hiertable <B1-Enter> [namespace code {
  ...
  bind Hiertable <KeyPress-Up> [namespace code {
      MoveFocus %W up
      if { $space } {
  ...
  bind Hiertable <KeyPress-Down> [namespace code {
      MoveFocus %W down
      if { $space } {
          %W selection toggle focus
      }
  ...
  bind Hiertable <Shift-KeyPress-Up> [namespace code {
      MoveFocus %W prevsibling
  }]

  bind Hiertable <Shift-KeyPress-Down> [namespace code {
      MoveFocus %W nextsibling
  }]

  bind Hiertable <KeyPress-Prior> [namespace code {
      MovePage %W top
  }]

  bind Hiertable <KeyPress-Next> [namespace code {
      MovePage %W bottom
  }]
  ...
  bind Hiertable <KeyPress-space> [namespace code {
  ...
  bind Hiertable <KeyRelease-space> [namespace code { 
      set space off
  }]

  bind Hiertable <KeyPress-Return> [namespace code {
      MoveFocus %W focus
      set space on
  }]

  bind Hiertable <KeyRelease-Return> [namespace code { 
      set space off
  }]

  bind Hiertable <KeyPress> [namespace code {
      NextMatchingEntry %W %A
  }]

  bind Hiertable <KeyPress-Home> [namespace code {
      MoveFocus %W top
  }]

  bind Hiertable <KeyPress-End> [namespace code {
      MoveFocus %W bottom
  }]
  ...
  # ----------------------------------------------------------------------
  #
  # USAGE: ::rbc::Hiertable::Init <hiertable> 
  #
  ...
  proc Init { widget } {
      ...
      $widget bind Entry <ButtonPress-1> [namespace code {
      ...
      #
      $widget bind Entry <B1-Motion> [namespace code { 
          set x %x
          set y %y
      ...
      #
      $widget bind Entry <ButtonRelease-1> [namespace code { 
          if { [%W cget -selectmode] == "multiple" } {
      ...
      $widget bind Entry <Shift-ButtonPress-1> [namespace code { 
      ...
      $widget bind Entry <Shift-ButtonRelease-1> [namespace code { 
          after cancel $afterId
          set scroll 0
      }]
      ...
      #	For "multiple" mode only.  
      #
      $widget bind Entry <Control-ButtonPress-1> [namespace code { 
          if { [%W cget -selectmode] == "multiple" } {
      ...
      $widget bind Entry <Control-ButtonRelease-1> [namespace code { 
          after cancel $afterId
          set scroll 0
      }]

      $widget bind Entry <Control-Shift-ButtonPress-1> [namespace code { 
          if { [%W cget -selectmode] == "multiple" && [%W selection present] } {
              if { [%W index anchor] == "" } {
                  %W selection anchor current
              }
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::Hiertable::AutoScroll <hiertable>
  #
  ...
  proc AutoScroll { widget } {
      ...
      if { [$widget cget -selectmode] == "single" } {
          SetSelectionAnchor $widget $neighbor
      } else {
          $widget selection mark $index
      }
      variable afterId [after 10 ::rbc::Hiertable::AutoScroll $widget]
  }

  proc SetSelectionAnchor { widget index } {
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::Hiertable::MovePage <hiertable> <where>
  # Arguments:	hiertable		hierarchy widget
  #
  ...
  # ----------------------------------------------------------------------
  # USAGE: ::rbc::Hiertable::NextMatchingEntry <hiertable> <char>
  # Arguments:	hiertable		hierarchy widget
  #
  ...
  proc NextMatchingEntry { widget key } {
      if {[string match {[ -~]} $key]} {
  ...
  image create photo ::rbc::Hiertable::CloseNormalFolder -format gif -data {
R0lGODlhEAANAMIAAAAAAH9/f///////AL+/vwAA/wAAAAAAACH5BAEAAAUALAAAAAAQAA0A
AAM8WBrM+rAEQWmIb5KxiWjNInCkV32AJHRlGQBgDA7vdN4vUa8tC78qlrCWmvRKsJTquHkp
ZTKAsiCtWq0JADs=
}
  image create photo ::rbc::Hiertable::OpenNormalFolder -format gif -data {
R0lGODlhEAANAMIAAAAAAH9/f///////AL+/vwAA/wAAAAAAACH5BAEAAAUALAAAAAAQAA0A
AAM1WBrM+rAEMigJ8c3Kb3OSII6kGABhp1JnaK1VGwjwKwtvHqNzzd263M3H4n2OH1QBwGw6
nQkAOw==
}
  image create photo ::rbc::Hiertable::CloseActiveFolder -format gif -data {
R0lGODlhEAANAMIAAAAAAH9/f/////+/AL+/vwAA/wAAAAAAACH5BAEAAAUALAAAAAAQAA0A
AAM8WBrM+rAEQWmIb5KxiWjNInCkV32AJHRlGQBgDA7vdN4vUa8tC78qlrCWmvRKsJTquHkp
ZTKAsiCtWq0JADs=
}
  image create photo ::rbc::Hiertable::OpenActiveFolder -format gif -data {
R0lGODlhEAANAMIAAAAAAH9/f/////+/AL+/vwAA/wAAAAAAACH5BAEAAAUALAAAAAAQAA0A
AAM1WBrM+rAEMigJ8c3Kb3OSII6kGABhp1JnaK1VGwjwKwtvHqNzzd263M3H4n2OH1QBwGw6
nQkAOw==
}
  ...
  bind HiertableEditor <KeyPress> [namespace code {
      Insert %W %A
  }]
  ...
  bind HiertableEditor <Shift-Return> [namespace code {
      Insert %W "\n"
  }]
  ...
  if { [string compare $::tcl_platform(platform) "windows"] != 0 } {
      bind HiertableEditor <Insert> [namespace code {
          catch {Insert %W [selection get -displayof %W]}
      }]
  }
  ...
  if 0 {
      ...
      bind HiertableEditor <Meta-b> [namespace code {
          %W text icursor [PreviousWord %W insert]
          %W text selection clear
      }]
      bind HiertableEditor <Meta-d> [namespace code {
          %W delete insert [NextWord %W insert]
      }]
      bind HiertableEditor <Meta-f> [namespace code {
          %W text icursor [NextWord %W insert]
          %W text selection clear
      }]
      bind HiertableEditor <Meta-BackSpace> [namespace code {
          %W delete [PreviousWord %W insert] insert
      }]
      bind HiertableEditor <Meta-Delete> [namespace code {
          %W delete [PreviousWord %W insert] insert
      }]
