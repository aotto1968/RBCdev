...
bind Hiertable <ButtonPress-2> {
    set rbc::Hiertable::cursor [%W cget -cursor]
...
bind Hiertable <ButtonRelease-2> {
    %W configure -cursor $rbc::Hiertable::cursor
}

bind Hiertable <B1-Leave> {
    if { $rbc::Hiertable::scroll } {
	rbc::Hiertable::AutoScroll %W 
    }
}

bind Hiertable <B1-Enter> {
    after cancel $rbc::Hiertable::afterId
}
...
bind Hiertable <KeyPress-Up> {
    rbc::Hiertable::MoveFocus %W up
    if { $rbc::Hiertable::space } {
	%W selection toggle focus
    }
}

bind Hiertable <KeyPress-Down> {
    rbc::Hiertable::MoveFocus %W down
    if { $rbc::Hiertable::space } {
	%W selection toggle focus
    }
}
...
bind Hiertable <Shift-KeyPress-Up> {
    rbc::Hiertable::MoveFocus %W prevsibling
}

bind Hiertable <Shift-KeyPress-Down> {
    rbc::Hiertable::MoveFocus %W nextsibling
}

bind Hiertable <KeyPress-Prior> {
    rbc::Hiertable::MovePage %W top
}

bind Hiertable <KeyPress-Next> {
    rbc::Hiertable::MovePage %W bottom
}
...
bind Hiertable <KeyPress-space> {
    ...
    set rbc::Hiertable::space on
}

bind Hiertable <KeyRelease-space> { 
    set rbc::Hiertable::space off
}

bind Hiertable <KeyPress-Return> {
    rbc::Hiertable::MoveFocus %W focus
    set rbc::Hiertable::space on
}
...
bind Hiertable <KeyPress> {
    rbc::Hiertable::NextMatchingEntry %W %A
}

bind Hiertable <KeyPress-Home> {
    rbc::Hiertable::MoveFocus %W top
}

bind Hiertable <KeyPress-End> {
    rbc::Hiertable::MoveFocus %W bottom
}
...
#
# ----------------------------------------------------------------------
proc rbc::Hiertable::Init { widget } {
    #
	...
	rbc::Hiertable::SetSelectionAnchor %W current
	set rbc::Hiertable::scroll 1
    }
	...
	set rbc::Hiertable::x %x
	set rbc::Hiertable::y %y
	set index [%W nearest %x %y]
	if { [%W cget -selectmode] == "multiple" } {
	    %W selection mark $index
	} else {
	    rbc::Hiertable::SetSelectionAnchor %W $index
	}
    }
...
#
# ----------------------------------------------------------------------
proc rbc::Hiertable::AutoScroll { widget } {
    if { ![winfo exists $widget] } {
	return
    }
    set x $rbc::Hiertable::x
    set y $rbc::Hiertable::y
	...
	rbc::Hiertable::SetSelectionAnchor $widget $neighbor
    } else {
	$widget selection mark $index
    }
    set ::rbc::Hiertable::afterId [after 10 rbc::Hiertable::AutoScroll $widget]
}

proc rbc::Hiertable::SetSelectionAnchor { widget index } {
...
# "nextsibling", etc.
# ----------------------------------------------------------------------
proc rbc::Hiertable::MoveFocus { widget where } {
...
proc rbc::Hiertable::MovePage { widget where } {
...
proc rbc::Hiertable::NextMatchingEntry { widget key } {
    if {[string match {[ -~]} $key]} {
...
proc rbc::Hiertable::GetSelection {w} {
...
if 0 {
	...
	%W text icursor [rbc::Hiertable::PreviousWord %W insert]
	%W text selection clear
    }
    bind HiertableEditor <Meta-d> {
	%W delete insert [rbc::Hiertable::NextWord %W insert]
    }
    bind HiertableEditor <Meta-f> {
	%W text icursor [rbc::Hiertable::NextWord %W insert]
	%W text selection clear
    }
    bind HiertableEditor <Meta-BackSpace> {
	%W delete [rbc::Hiertable::PreviousWord %W insert] insert
    }
    ...
    proc rbc::Hiertable::PreviousWord {w start} {
